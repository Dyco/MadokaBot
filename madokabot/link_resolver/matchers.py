...
acfun_matcher = on_regex(r"(acfun\.cn)", rule=resolver_prefix_rule)
twitter_matcher = on_regex(r"(x\.com)", rule=resolver_prefix_rule, priority=1)
...
kugou_matcher = on_regex(r"(kugou\.com)", rule=resolver_prefix_rule)
